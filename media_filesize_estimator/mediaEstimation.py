...
class Estimation:
    ...
    def estimate(self, mediaProperty=None):
        ...
        if mediaType == "video":
            ...
            if mediaProperty == "resolution":
                ...
                raise Exception(f"Please test with a different property as the given video file does not estimate property : {mediaProperty}")
            ...
            if mediaProperty == "sampling_rate":
                ...
                raise Exception(f"Please test with a different property as the given audio file does not estimate property : {mediaProperty}")
    ...
    def calculateAudioSize(
        ...
        Calculate file size based on the parameters
        """
        file_size_bytes = (audio_sampling_rate * audio_bit_depth * audio_channels * audio_duration) / 8
